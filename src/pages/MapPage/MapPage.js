    ...
    <>
      <GoogleMap
        ...
        mapContainerClassName={
          isHomePath
            ? "w-11/12 h-full max-h-144 max-w-5xl rounded-b-none rounded-xl sm:ml-12 sm:mt-16 drop-shadow-md "
            : "w-10/12 sm:w-full h-92 sm:h-full sm:max-h-148 sm:ml-12 sm:mr-12 sm:mt-16 rounded-md"
        }
        zoom={14}
        center={center}
        options={options}
